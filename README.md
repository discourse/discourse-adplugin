...
**Authors**: [Sarah Ni](https://github.com/cyberkoi) & [Vi Nguyen](https://github.com/ladydanger)<br> **Version**: 1.0.3<br> **Contributors**: See credits section below<br> **License**: MIT License<br> **Supported Discourse Version**: 1.4<br> **Supported Ad Platforms**:    
