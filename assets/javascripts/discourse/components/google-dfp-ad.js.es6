...
function defineSlot(placement, settings) {
  ...
  if (placement === "topic-list-top" && settings.dfp_topic_list_top_code && settings.dfp_topic_list_top_ad_sizes) {
    ...
    if (Discourse.Mobile.mobileView) {
      var topic_list_top_mobile = googletag.defineSlot('/' + settings.dfp_publisher_id + '/' + settings.dfp_mobile_topic_list_top_code, [const_mobile_width, const_mobile_height], 'div-gpt-ad-topic-list-top').addService(googletag.pubads());
  ...
  if (placement === "topic-above-post-stream" && settings.dfp_topic_above_post_stream_code && settings.dfp_topic_above_post_stream_ad_sizes) {
    ...
    if (Discourse.Mobile.mobileView) {
      var topic_above_post_stream_mobile = googletag.defineSlot('/' + settings.dfp_publisher_id + '/' + settings.dfp_mobile_topic_above_post_stream_code, [const_mobile_width, const_mobile_height], 'div-gpt-ad-topic-above-post-stream').addService(googletag.pubads());
  ...
  if (placement === "topic-above-suggested" && settings.dfp_topic_above_suggested_code && settings.dfp_topic_above_suggested_ad_sizes) {
    ...
    if (Discourse.Mobile.mobileView) {
      var topic_above_suggested_mobile = googletag.defineSlot('/' + settings.dfp_publisher_id + '/' + settings.dfp_mobile_topic_above_suggested_code, [const_mobile_width, const_mobile_height], 'div-gpt-ad-topic-above-suggested').addService(googletag.pubads());
  ...
  if (placement === "post-bottom" && settings.dfp_post_bottom_code && settings.dfp_post_bottom_ad_sizes) {
    ...
    if (Discourse.Mobile.mobileView) {
      var post_bottom_mobile = googletag.defineSlot('/' + settings.dfp_publisher_id + '/' + settings.dfp_mobile_post_bottom_code, [const_mobile_width, const_mobile_height], 'div-gpt-ad-post-bottom').addService(googletag.pubads());
